##########################################################################################################
#   Description: 纵向加密连接图利旧现有成端IDF设备节点
...
class CryptoExistedEdgedIDF(CommonCryptoDev):
    '''纵向加密连接图利旧现有成端IDF设备节点'''

    DEVICE_NAME = "利旧现有成端IDF"
    DEVICE_TYPE = CryptoDeviceType.EXISTED_EDGED_IDF
    IS_NEW = True
